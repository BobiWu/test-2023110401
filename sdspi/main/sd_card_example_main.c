...
static uint8_t cubeShakeHappen = 0;
...
#define SUB_CUBE2//MAIN_CUBE,SUB_CUBE1,SUB_CUBE2,SUB_CUBE3,SUB_CUBE4
/*
...
*/
    ...
    */
    ...
    AW9523B_register_write_byte(OUTPUT_PORT1, 0x40);//0b01000000    //0b11000000
